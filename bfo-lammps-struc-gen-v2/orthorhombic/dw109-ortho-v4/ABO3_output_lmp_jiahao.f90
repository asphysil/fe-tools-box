...
REAL(dp_real), dimension(4, 3*nsti):: o_atms_all
...
DO i =1, 3*nsti 
o_atms_all(1,i) = o_atms(1,i)
  DO j=1,3 
    o_atms_all(j+1,i) = (o_atms(j+1,i)/latt_sup(j,j))*latt_strain(j,j)
  ENDDO
...
SUBROUTINE lammps_struc_inp_spinfull(nsba, nsti, nso1, nso2, nso3, all_angle_ti_o_ti, fe_bfo)
 ...
 DO i =1,  nsti
    ...
    nti2 = all_angle_ti_o_ti(3, ncout) + nsba
      ...
      WRITE(15,*)ncout, 1, nti1, no, nti2 
 ENDDO 
 END SUBROUTINE lammps_struc_inp_spinfull
