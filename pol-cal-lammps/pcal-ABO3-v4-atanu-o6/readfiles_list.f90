MODULE readfiles
 ...
 use data_structure, only : latt_vec, a_atms, b_atms, o_atms, sp, tndump 
    IMPLICIT NONE 
private
public :: readdump_type1,readdump_type2
contains
...
SUBROUTINE readdump_type2(na, nb, no)
   ...
   !!*********Reading files***********!!
      ...
      READ(fileID_in,*)
   DO i=1, na
       READ (fileID_in,*) id, type, a_atms(1,i), a_atms(2,i), a_atms(3,i)
    ENDDO
   
    DO i=1, nb
     READ(fileID_in,*) id, type, b_atms(1,i), b_atms(2,i), b_atms(3,i), sp(1,i), sp(2,i), sp(3,i)
    ENDDO
     
   DO i=1, no
      READ(fileID_in,*) id, type, o_atms(1,i), o_atms(2,i), o_atms(3,i)
    ENDDO
